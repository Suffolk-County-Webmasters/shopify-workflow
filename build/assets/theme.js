...
this.Shopify.theme.PredictiveSearch = (function () {
    ...
    function request(configParams, query, onSuccess, onError) {
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.status === 417) {
                try {
                    var invalidParameterJson = JSON.parse(
                        xhr.responseText,
                    );
            ...
            if (xhr.status === 422) {
                try {
                    var expectationFailedJson = JSON.parse(
                        xhr.responseText,
                    );
    ...
    DispatcherEvent.prototype.unregisterCallback = function (
        callback,
    ) {
    ...
    PredictiveSearch.prototype.off = function on(
        eventName,
        callback,
    ) {
...
this.Shopify.theme.PredictiveSearchComponent = (function (
        ...
        resources: {
            ...
            options: {
                unavailable_products:
                    PredictiveSearch.UNAVAILABLE_PRODUCTS.LAST,
                fields: [
    ...
    PredictiveSearchComponent.prototype._addInputEventListeners = function () {
        ...
        this._handleInputKeydown = this._handleInputKeydown.bind(
            this,
        );
        ...
        if (reset) {
            this._handleInputReset = this._handleInputReset.bind(
                this,
            );
    ...
    PredictiveSearchComponent.prototype._addBodyEventListener = function () {
        this._handleBodyMousedown = this._handleBodyMousedown.bind(
            this,
        );
        ...
        if (this.isResultVisible && this.nodes !== null) {
            if (
                ...
                if (isFunction(this.callbacks.onBodyMousedown)) {
                    var returnedValue = this.callbacks.onBodyMousedown(
                        this.nodes,
                    );
    ...
    PredictiveSearchComponent.prototype._handleInputFocus = function (
        evt,
    ) {
        if (isFunction(this.callbacks.onInputFocus)) {
            var returnedValue = this.callbacks.onInputFocus(
                this.nodes,
            );
            if (isBoolean(returnedValue) && !returnedValue) {
                return false;
        ...
        setTimeout(
            function () {
                if (isFunction(this.callbacks.onInputBlur)) {
                    var returnedValue = this.callbacks.onInputBlur(
                        this.nodes,
                    );
                    if (isBoolean(returnedValue) && !returnedValue) {
                        return false;
    ...
    PredictiveSearchComponent.prototype._addAccessibilityAnnouncer = function () {
        this._accessibilityAnnouncerDiv = window.document.createElement(
            'div',
        );
    ...
    PredictiveSearchComponent.prototype._announceNumberOfResultsFound = function (
        ...
        var currentAnnouncedMessage = this._accessibilityAnnouncerDiv
            .innerHTML;
    ...
    PredictiveSearchComponent.prototype._handleInputKeyup = function (
        evt,
    ) {
        ...
        if (isFunction(this.callbacks.onInputKeyup)) {
            var returnedValue = this.callbacks.onInputKeyup(
                this.nodes,
            );
            if (isBoolean(returnedValue) && !returnedValue) {
                return false;
    ...
    PredictiveSearchComponent.prototype._handleInputReset = function (
        evt,
    ) {
        evt.preventDefault();

        if (isFunction(this.callbacks.onInputReset)) {
            var returnedValue = this.callbacks.onInputReset(
                this.nodes,
            );
            if (isBoolean(returnedValue) && !returnedValue) {
                return false;
    ...
    PredictiveSearchComponent.prototype._getSelectedOption = function () {
        return this.nodes.result.querySelector(
            '.' + this.classes.itemSelected,
        );
    };
    ...
    PredictiveSearchComponent.prototype._search = function () {
        ...
        this._latencyTimer = setTimeout(
            function () {
                ...
                this.nodes.result.classList.add(
    ...
    PredictiveSearchComponent.prototype._setKeyword = function (
        keyword,
    ) {
    ...
    PredictiveSearchComponent.prototype._toggleClearButtonVisibility = function () {
        ...
        if (this.nodes.input.value.length > 0) {
            this.nodes.reset.classList.add(
    ...
    PredictiveSearchComponent.prototype.open = function () {
        ...
        if (isFunction(this.callbacks.onBeforeOpen)) {
            var returnedValue = this.callbacks.onBeforeOpen(
                this.nodes,
            );
            if (isBoolean(returnedValue) && !returnedValue) {
                return false;
    ...
    PredictiveSearchComponent.prototype.close = function () {
        ...
        if (isFunction(this.callbacks.onBeforeClose)) {
            var returnedValue = this.callbacks.onBeforeClose(
                this.nodes,
            );
            if (isBoolean(returnedValue) && !returnedValue) {
                return false;
    ...
    PredictiveSearchComponent.prototype.destroy = function () {
        ...
        if (isFunction(this.callbacks.onBeforeDestroy)) {
            var returnedValue = this.callbacks.onBeforeDestroy(
                this.nodes,
            );
            if (isBoolean(returnedValue) && !returnedValue) {
                return false;
...
theme.TouchEvents.prototype = Object.assign(
    ...
    theme.TouchEvents.prototype,
    {
        ...
        _setupEventHandlers: function () {
            this.eventHandlers.preventDefault = this._preventDefault.bind(
                this,
            );
            this.eventHandlers.preventClick = this._preventClick.bind(
                this,
            );
            this.eventHandlers.touchStart = this._touchStart.bind(
                this,
            );
        ...
        _touchMove: function (event) {
            ...
            document[
                'on' + this.events[this.eventType][1]
            ] = function (event) {
            ...
            if (!this.axis) {
                if (
                    ...
                    Math.abs(this.difference.xPosition)
                ) {
                    this.axis = 'xPosition';
                } else if (
                    this.options.dragThreshold <
                    Math.abs(this.difference.yPosition)
                ) {
                    this.axis = 'yPosition';
                } else {
                    this.axis = false;
                ...
                this.direction =
                    this.difference.yPosition < 0 ? 'up' : 'down';
            }
...
theme.Header = (function () {
    ...
    function cacheSelectors() {
        ...
        cache = {
            nav: navigation,
            topLevel: document.querySelectorAll(
                selectors.siteNavLinkMain,
            ),
            parents: navigation.querySelectorAll(
                selectors.siteNavHasDropdown,
            ),
            subMenuLinks: document.querySelectorAll(
                selectors.siteNavChildLinks,
            ),
    ...
    function styleDropdowns(dropdownListItems) {
        dropdownListItems.forEach(function (item) {
            var dropdownLi = item.querySelector(
                selectors.siteNavDropdown,
            );
    ...
    function positionFullWidthDropdowns() {
        document
            ...
            .forEach(function (el) {
                ...
                fullWidthDropdown.style.top =
                    fullWidthDropdownOffset + 'px';
            });
    }
...
theme.MobileNav = (function () {
    ...
    function init() {
        ...
        cache.mobileNavToggle.addEventListener(
            'click',
            toggleMobileNav,
        );
    ...
    function initBreakpoints() {
        if (
            mql.matches &&
            cache.mobileNavContainer.classList.contains(
                classes.navOpen,
            )
        ) {
            closeMobileNav();
    ...
    function cacheSelectors() {
        cache = {
            ...
            mobileNavToggle: document.querySelector(
                '.js-mobile-nav-toggle',
            ),
            mobileNavContainer: document.querySelector(
                '.mobile-nav-wrapper',
            ),
            mobileNav: document.querySelector('#MobileNav'),
            sectionHeader: document.querySelector(
    ...
    function openMobileNav() {
        ...
        cache.pageContainer.style.transform =
            'translate3d(0, ' +
            cache.mobileNavContainer.scrollHeight +
            'px, 0)';
        ...
        cache.mobileNavToggle.classList.add(
            classes.mobileNavCloseIcon,
        );
        cache.mobileNavToggle.classList.remove(
            classes.mobileNavOpenIcon,
        );
    ...
    function goToSubnav(target) {
        var targetMenu = target
            ? document.querySelector(
                  '.mobile-nav__dropdown[data-parent="' +
                      target +
                      '"]',
              )
            : cache.mobileNav;
        ...
        cache.mobileNavContainer.style.height =
            translateMenuHeight + 'px';
        ...
        var container =
            menuLevel === 1 ? cache.sectionHeader : targetMenu;
...
theme.Slideshow = (function () {
    ...
    function Slideshow(container, options) {
        ...
        this.adaptHeight =
            this.sliderContainer.getAttribute('data-adapt-height') ===
            'true';
    ...
    Slideshow.prototype = Object.assign({}, Slideshow.prototype, {
        ...
        destroy: function () {
            ...
            this.indicators.forEach(function (indicatorWrapper) {
                indicatorWrapper.childNodes.forEach(function (
                    indicator,
                ) {
        ...
        _setupEventHandlers: function () {
            ...
            this.eventHandlers.clickButton = this._onClickButton.bind(
                this,
            );
            this.eventHandlers.onClickIndicator = this._onClickIndicator.bind(
                this,
            );
            this.eventHandlers.onKeydownIndicator = this._onKeydownIndicator.bind(
                this,
            );
            this.eventHandlers.onClickPause = this._onClickPause.bind(
                this,
            );
        ...
        _setupTouchEvents: function () {
            this.touchEvents = new theme.TouchEvents(
                this.sliderTrack,
                {
                    start: function () {
                        this._onTouchStart();
        ...
        _onClickButton: function (event) {
            ...
            var nextButton = button.hasAttribute(
                attributes.buttonNext,
            );
        ...
        _onClickIndicator: function (event) {
            ...
            this.slideIndex = Number(
                event.target.dataset.slideNumber,
            );
        ...
        _onKeydownIndicator: function (event) {
            if (event.keyCode !== slate.utils.keyboardKeys.ENTER)
                return;
        ...
        _moveSlideshow: function (direction) {
            ...
            this.nextMinIndex =
                direction === 'next'
                    ? currentActiveSlidesMinIndex +
                      this.options.slidesToShow
                    : currentActiveSlidesMinIndex -
                      this.options.slidesToShow;
            this.nextMaxIndex =
                direction === 'next'
                    ? currentActiveSlidesMaxIndex +
                      this.options.slidesToShow
        ...
        _setupActiveSlide: function (index) {
            ...
            this.slides[index].classList.add(
                this.options.slideActiveClass,
            );
        },
        ...
        _setupMultipleActiveSlide: function (minIndex, maxIndex) {
            this.slides.forEach(function (slide) {
                ...
                var sliderItemLink = slide.querySelector(
                    selectors.sliderItemLink,
                );
        ...
        _setActiveIndicator: function (index) {
            this.indicators.forEach(function (indicatorWrapper) {
                ...
                var nextIndicator =
                    indicatorWrapper.childNodes[index];
                ...
                nextIndicator.firstElementChild.setAttribute(
                    'aria-current',
                    true,
                );
            }, this);
        ...
        _getNextSlideIndex: function (direction) {
            ...
            if (direction === 'next') {
                if (this.slideIndex === this.lastSlide) {
                    return this.options.type === 'slide'
                        ? this.lastSlide
                        : 0;
                }
        ...
        _getActiveSlidesIndex: function () {
            var currentActiveSlides = this.slides.filter(function (
                sliderItem,
            ) {
                if (
        ...
        _getTranslateXPosition: function () {
            return Number(
                this.sliderTrack.style.transform.match(
                    /(-?[0-9]+)/g,
                )[0],
            );
        },
...
theme.Video = (function () {
    ...
    function init(video) {
        ...
        videos[video.id] = {
            ...
            status:
                video.dataset.type === 'image_with_play'
                    ? 'closed'
                    : 'background', // closed, open, background
            video: video,
    ...
    function setAsPlaying(videoData) {
        var videoWrapper = videoData.videoWrapper;
        var pauseButton = videoWrapper.querySelector(
        ...
        setTimeout(function () {
            videoWrapper
                .querySelector(selectors.closeVideoBtn)
                .focus();
    ...
    function toggleExpandVideo(playerId, expand) {
        ...
        var elementTop =
            video.videoWrapper.getBoundingClientRect().top +
            window.pageYOffset;
        var playButton = video.videoWrapper.querySelector(
        ...
        if (expand) {
            if (isMobile()) {
                ...
                newHeight =
                    video.videoWrapper.offsetWidth /
                    videoOptions.ratio;
            }
            offset = (window.innerHeight - newHeight) / 2;

            video.videoWrapper.style.height =
                video.videoWrapper.getBoundingClientRect().height +
                'px';
            video.videoWrapper.classList.remove(
                classes.wrapperMinHeight,
            );
            ...
            setTimeout(function () {
                video.videoWrapper.classList.add(
                    classes.wrapperMinHeight,
                );
            }, 600);
    ...
    function togglePause(playerId) {
        ...
        var paused = pauseButton.classList.contains(
            classes.userPaused,
        );
        if (paused) {
            pauseButton.classList.remove(classes.userPaused);
    ...
    function sizeBackgroundVideo(videoPlayer) {
        ...
        if (isMobile()) {
            ...
            var videoWrapper = videoPlayer.closest(
                selectors.videoWrapper,
            );
            ...
            if (videoWidth / videoOptions.ratio < desktopHeight) {
                playerWidth = Math.ceil(
                    desktopHeight * videoOptions.ratio,
                ...
                desktopHeight = Math.ceil(
                    videoWidth / videoOptions.ratio,
    ...
    var handleWindowResize = theme.Helpers.debounce(function () {
        ...
        if (isMobile()) {
            for (key in videos) {
                if (videos.hasOwnProperty(key)) {
                    if (
                        videos[key].videoWrapper.classList.contains(
                            classes.playing,
                        )
                    ) {
                        if (!fullscreen) {
    ...
    var handleWindowScroll = theme.Helpers.debounce(function () {
        ...
        for (var key in videos) {
            if (videos.hasOwnProperty(key)) {
                ...
                if (
                    videoWrapper.classList.contains(classes.playing)
                ) {
                    if (!condition) return;
                    closeVideo(key);
    ...
    function initEvents() {
        var playVideoBtns = document.querySelectorAll(
            selectors.playVideoBtn,
        );
        var closeVideoBtns = document.querySelectorAll(
            selectors.closeVideoBtn,
        );
        var pauseVideoBtns = document.querySelectorAll(
            selectors.pauseVideoBtn,
        );
    ...
    function setButtonLabels(videoWrapper, title) {
        var playButtons = videoWrapper.querySelectorAll(
            selectors.playVideoBtn,
        );
        var closeButton = videoWrapper.querySelector(
            selectors.closeVideoBtn,
        );
        var pauseButton = videoWrapper.querySelector(
            selectors.pauseVideoBtn,
        );
        var closeButtonText = closeButton.querySelector(
            selectors.fallbackText,
        );

        var pauseButtonStop = pauseButton.querySelector(
            selectors.pauseVideoStop,
        );
        ...
        playButtons.forEach(function (playButton) {
            var playButtonText = playButton.querySelector(
                selectors.fallbackText,
            );
...
theme.ProductVideo = (function () {
    ...
    function init(videoContainer, sectionId) {
        ...
        var videoElement = videoContainer.querySelector(
            'iframe, video',
        );
    ...
    function createPlayer(video) {
        ...
        productMediaWrapper.addEventListener(
            'mediaHidden',
            pauseVideo,
        );
...
theme.ProductModel = (function () {
    ...
    function init(modelViewerContainers, sectionId) {
        ...
        modelViewerContainers.forEach(function (
            ...
            var mediaId = modelViewerContainer.getAttribute(
                'data-media-id',
            );
            var modelViewerElement = modelViewerContainer.querySelector(
                'model-viewer',
            );
            var modelId = modelViewerElement.getAttribute(
                'data-model-id',
            );
            ...
            if (index === 0) {
                ...
                var xrButton = mediaGroup.querySelector(
                    selectors.xrButton,
                );
                xrButtons[sectionId] = {
                    element: xrButton,
...
theme.FormStatus = (function () {
    ...
    function init() {
        var statusMessages = document.querySelectorAll(
...
theme.Hero = (function () {
    ...
    function hero(el, sectionId) {
        ...
        var heroImage = parentSection.querySelector(
...
theme.SearchResultsTemplate = (function () {
    ...
    function getProductImage(product) {
        ...
        if (image !== null) {
            image = {
                url: theme.Images.getSizedImageUrl(
                    featuredImage.url,
                    '100x',
                ),
    ...
    window.theme.Search = (function () {
        ...
        function init() {
            ...
            Object.keys(mediaQueryList).forEach(function (device) {
                mediaQueryList[device].addListener(
    ...
    Disclosure.prototype = Object.assign({}, Disclosure.prototype, {
        ...
        _setupEventHandlers: function () {
            return {
                ...
                onDisclosureListFocusOut: this._onDisclosureListFocusOut.bind(
                    this,
                ),
                onDisclosureToggleFocusOut: this._onDisclosureToggleFocusOut.bind(
                    this,
                ),
            };
        },
        ...
        _onDisclosureKeyUp: function (event) {
            if (event.which !== slate.utils.keyboardKeys.ESCAPE)
                return;
            this._hideList();
...
theme.Zoom = (function () {
    ...
    Zoom.prototype = Object.assign({}, Zoom.prototype, {
        _cacheSelectors: function () {
            this.cache = {
                sourceImage: this.container.querySelector(
                    selectors.imageZoom,
                ),
            };
        },
        ...
        _init: function () {
            ...
            this.xRatio =
                (this.cache.sourceImage.width - targetWidth) /
                this.sourceWidth;
            this.yRatio =
        ...
        _move: function (e) {
            ...
            this.cache.targetImage.style.left =
                -(left * -this.xRatio) + 'px';
            this.cache.targetImage.style.top =
                -(top * -this.yRatio) + 'px';
...
/* ================ TEMPLATES ================ */
(function () {
    var filterBys = document.querySelectorAll(
...
theme.customerTemplates = (function () {
    ...
    function initEventListeners() {
        this.recoverHeading = document.querySelector(
            selectors.RecoverHeading,
        );
        this.recoverEmail = document.querySelector(
            selectors.RecoverEmail,
        );
        this.loginHeading = document.querySelector(
            selectors.LoginHeading,
        );
        var recoverPassword = document.getElementById(
            'RecoverPassword',
        );
        ...
        if (recoverPassword) {
            recoverPassword.addEventListener(
                ...
                function (evt) {
                    ...
                    this.recoverHeading.setAttribute(
                        'tabindex',
                        '-1',
                    );
        ...
        if (this.recoverHeading) {
            this.recoverHeading.addEventListener('blur', function (
                evt,
            ) {
                evt.target.removeAttribute('tabindex');
            });
    ...
    function customerAddressForm() {
        var newAddressForm = document.getElementById(
            'AddressNewForm',
        );
        var newAddressFormButton = document.getElementById(
            'AddressNewButton',
        );
        ...
        document
            ...
            .forEach(function (button) {
                button.addEventListener('click', function () {
                    var isExpanded =
                        newAddressFormButton.getAttribute(
                            'aria-expanded',
                        ) === 'true';

                    newAddressForm.classList.toggle('hide');
                    newAddressFormButton.setAttribute(
                        'aria-expanded',
                        !isExpanded,
                    );
        ...
        document
            ...
            .forEach(function (button) {
                button.addEventListener('click', function (evt) {
                    ...
                    var editAddress = document.getElementById(
                        'EditAddress_' + formId,
                    );
                    var isExpanded =
...
theme.Cart = (function () {
    ...
    function Cart(container) {
        this.container = container;
        this.thumbnails = this.container.querySelectorAll(
            selectors.thumbnails,
        );
        this.quantityInputs = this.container.querySelectorAll(
            selectors.inputQty,
        );

        this.ajaxEnabled = this.container.getAttribute(
            'data-ajax-enabled',
        );
    ...
    Cart.prototype = Object.assign({}, Cart.prototype, {
        _setupCartTemplates: function () {
            var cartItem = this.container.querySelector(
                selectors.cartItem,
            );
            if (!cartItem) return;
        ...
        _handleInputQty: function (evt) {
            ...
            var itemIndex = Number(
                input.getAttribute('data-quantity-item'),
            );
        ...
        _updateItemQuantity: function (
            ...
            var key = itemElement.getAttribute(
                attributes.cartItemKey,
            );
            var index = Number(
                itemElement.getAttribute(attributes.cartItemIndex),
            );
        ...
        _createCart: function (state) {
            var cartDiscountList = this._createCartDiscountList(
                state,
            );

            var cartTable = this.container.querySelector(
                selectors.cartLineItems,
            );
            cartTable.innerHTML = '';

            this._createLineItemList(state).forEach(function (
                lineItem,
            ) {
            ...
            this.cartNotes =
                this.cartNotes ||
                this.container.querySelector(selectors.cartNote);
        ...
        _createCartDiscountList: function (cart) {
            return cart.cart_level_discount_applications.map(
                function (discount) {
                    var discountNode = this.cartDiscountTemplate.cloneNode(
                        true,
                    );

                    discountNode.querySelector(
                        selectors.cartDiscountTitle,
        ...
        _createLineItemList: function (state) {
            return state.items.map(
                function (item, index) {
                    ...
                    var itemPriceList = this.itemPriceListTemplate.cloneNode(
                        true,
                    );

                    this._setLineItemAttributes(
                        itemNode,
                        item,
                        index,
                    );
                    this._setLineItemImage(
                        itemNode,
                        item.featured_image,
                    );

                    var cartItemTitle = itemNode.querySelector(
                        selectors.cartItemTitle,
                    );
                    ...
                    var itemDiscountList = this._createItemDiscountList(
                        item,
                    );
                    this._setItemDiscountList(
                        itemNode,
                        itemDiscountList,
                    );
        ...
        _setLineItemAttributes: function (itemNode, item, index) {
            ...
            itemNode.setAttribute(
                attributes.cartItemQuantity,
                item.quantity,
            );
        },

        _setLineItemImage: function (itemNode, featuredImage) {
            var image = itemNode.querySelector(
                selectors.cartItemImage,
            );
        ...
        _setProductDetailsList: function (item, productDetailsList) {
            var itemDetails = item.querySelector(
                selectors.cartItemDetails,
            );

            if (productDetailsList.length) {
                itemDetails.classList.remove(classes.hide);
                itemDetails.innerHTML = productDetailsList.reduce(
        ...
        _setItemDiscountList: function (item, discountList) {
            ...
            if (discountList.length === 0) {
                ...
                itemDiscountList.innerHTML = discountList.reduce(
                    function (result, element) {
                        return result + element.outerHTML;
                    },
                    '',
        ...
        _setItemRemove: function (item, title) {
            item.querySelector(selectors.cartRemove).setAttribute(
                'aria-label',
        ...
        _setQuantityInputs: function (itemNode, item, index) {
            ...
            var desktopInput = itemNode.querySelector(
                selectors.quantityInputDesktop,
            );

            mobileInput.setAttribute('id', 'updates_' + item.key);
            desktopInput.setAttribute(
                'id',
        ...
        _getOptionList: function (options) {
            return options.map(
                function (option) {
                    var optionElement = this.itemOptionTemplate.cloneNode(
                        true,
                    );
        ...
        _getPropertyList: function (properties) {
            ...
            return propertiesArray.map(
                function (property) {
                    var propertyElement = this.itemPropertyTemplate.cloneNode(
                        true,
                    );
        ...
        _hideQuantityErrorMessage: function () {
            ...
            errorMessages.forEach(function (element) {
                ...
                element.querySelector(
                    selectors.cartQuantityErrorMessage,
                ).textContent = '';
            });
        ...
        _handleThumbnailClick: function (evt) {
            if (!evt.target.classList.contains(classes.thumbnails))
                return;
        ...
        _showCartError: function (elementToFocus) {
            document.querySelector(
                selectors.cartErrorMessage,
            ).textContent = theme.strings.cartError;
        ...
        _onRemoveItem: function (evt) {
            ...
            var index = Number(
                lineItem.getAttribute(attributes.cartItemIndex),
            );
        ...
        _showRemoveMessage: function (lineItem) {
            ...
            this.container
                .querySelector('[data-removed-item-row]')
                .focus();
        },

        _getRemoveMessage: function (lineItem) {
            var formattedMessage = this._formatRemoveMessage(
                lineItem,
            );
        ...
        _formatRemoveMessage: function (lineItem) {
            var quantity = lineItem.getAttribute(
                'data-cart-item-quantity',
            );
            var url = lineItem.getAttribute(attributes.cartItemUrl);
            var title = lineItem.getAttribute(
                attributes.cartItemTitle,
            );
        ...
        _setCartCountBubble: function (quantity) {
            ...
            this.cartCount =
                this.cartCount ||
                document.querySelector(selectors.cartCount);
        ...
        _emptyCart: function () {
            this.emptyPageContent =
                this.emptyPageContent ||
                this.container.querySelector(
                    selectors.emptyPageContent,
                );

            this.cartWrapper =
                this.cartWrapper ||
                this.container.querySelector(selectors.cartWrapper);
...
theme.Filters = (function () {
    ...
    function Filters(container) {
        this.filterSelect = container.querySelector(
            selectors.filterSelection,
        );
        this.sortSelect = container.querySelector(
            selectors.sortSelection,
        );

        this.selects = document.querySelectorAll(
            selectors.selectInput,
        );
    ...
    Filters.prototype = Object.assign({}, Filters.prototype, {
        ...
        onUnload: function () {
            ...
            if (this.sortSelect) {
                this.sortSelect.removeEventListener(
                    'change',
                    this._onSortChange,
                );
            }
...
theme.Maps = (function () {
    ...
    window.gm_authFailure = function () {
        ...
        document
            .querySelector(selectors.section)
            .classList.add(classes.mapError);
            ...
            return geolocate(this.map)
                ...
                .catch(
                    function () {
                        ...
                        if (Shopify.designMode) {
                            this.map.parentNode.classList.add(
                                classes.mapError,
                            );
...
theme.Product = (function () {
    function Product(container) {
        ...
        this.settings = {
            ...
            bpSmall: false,
            enableHistoryState:
                container.getAttribute('data-enable-history-state') ||
                false,
        ...
        this.selectors = {
            ...
            productThumbImages:
                '.product-single__thumbnail--' + sectionId,
            productThumbs: '.product-single__thumbnails-' + sectionId,
            productThumbListItem: '.product-single__thumbnails-item',
            productThumbsWrapper: '.thumbnails-wrapper',
            saleLabel: '.product-price__sale-label-' + sectionId,
            singleOptionSelector:
                '.single-option-selector-' + sectionId,
        ...
        this.quantityInput = container.querySelector(
            this.selectors.quantity,
        );
        this.errorMessageWrapper = container.querySelector(
            this.selectors.errorMessageWrapper,
        );
        this.addToCart = container.querySelector(
        ...
        this.loader = this.addToCart.querySelector(
        ...
        this.initMobileBreakpoint = this._initMobileBreakpoint.bind(
            this,
        );
        this.initDesktopBreakpoint = this._initDesktopBreakpoint.bind(
            this,
        );

        this.mqlSmall = window.matchMedia(
            this.settings.mediaQuerySmall,
        );
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
        ...
        _initVariants: function () {
            var options = {
                ...
                singleOptionSelector: this.selectors
                    .singleOptionSelector,
            ...
            this.eventHandlers.updateMedia = this._updateMedia.bind(
                this,
            );
            this.eventHandlers.updatePrice = this._updatePrice.bind(
                this,
            );
        ...
        _initMediaSwitch: function () {
            ...
            this.eventHandlers.handleMediaFocus = this._handleMediaFocus.bind(
                this,
            );
            ...
            productForm.addEventListener(
                ...
                function (evt) {
                    ...
                    if (!isInvalidQuantity && this.ajaxEnabled) {
                        ...
                        var form = this.container.querySelector(
                            this.selectors.productForm,
                        );
        ...
        _handleButtonLoadingState: function (isLoading) {
            if (isLoading) {
                ...
                if (this.shopifyPaymentButton) {
                    this.shopifyPaymentButton.removeAttribute(
                        'disabled',
                    );
                }
        ...
        _showErrorMessage: function (errorMessage) {
            ...
            if (this.quantityInput) {
                this.quantityInput.classList.add(
            ...
            this.errorMessageWrapper.setAttribute(
                'aria-hidden',
                true,
            );
        ...
        _hideErrorMessage: function () {
            ...
            if (this.quantityInput) {
                this.quantityInput.classList.remove(
                    this.classes.inputError,
                );
            }
        },
        ...
        _setupCartPopup: function (item) {
            this.cartPopup =
                this.cartPopup ||
                document.querySelector(this.selectors.cartPopup);
        ...
        _updateCartPopupContent: function (item) {
            ...
            var quantity = this.quantityInput
        ...
        _setupCartPopupEventListeners: function () {
            ...
            this.eventHandlers.hideCartPopup = this._hideCartPopup.bind(
                this,
            );
            this.eventHandlers.onBodyClick = this._onBodyClick.bind(
                this,
            );
        ...
        _setCartPopupPlaceholder: function (imageUrl) {
            ...
            if (imageUrl === null) {
                this.cartPopupImageWrapper.classList.add(
                    this.classes.hidden,
                );
                return;
            }
        ...
        _setCartPopupImage: function (imageUrl, imageAlt) {
            ...
            this.cartPopupImageWrapper.classList.remove(
                this.classes.hidden,
            );
            var sizedImageUrl = theme.Images.getSizedImageUrl(
                imageUrl,
                '200x',
            );
        ...
        _setCartPopupProductDetails: function (
            ...
            if (variantPropertiesHTML.length === 0) {
                ...
                this.cartPopupProductDetails.setAttribute(
                    'hidden',
                    '',
                );
            } else {
                this.cartPopupProductDetails.innerHTML = variantPropertiesHTML;
                this.cartPopupProductDetails.removeAttribute(
                    'hidden',
                );
            }
        },
        ...
        _setCartQuantity: function (quantity) {
            ...
            this.cartPopupCartQuantity.setAttribute(
                'aria-label',
                ariaLabel,
            );
        },
        ...
        _setActiveThumbnail: function (mediaId) {
            ...
            if (typeof mediaId === 'undefined') {
                ...
                mediaId = productMediaWrapper.getAttribute(
                    'data-media-id',
                );
            }

            var thumbnailWrappers = this.container.querySelectorAll(
                this.selectors.productThumbListItem +
                    ':not(.slick-cloned)',
            );
        ...
        _adjustThumbnailSlider: function (activeThumbnail) {
            var sliderItem = activeThumbnail.closest(
                '[data-slider-item]',
            );
            ...
            window.setTimeout(
                function () {
                    ...
                    this.slideshow.goToSlideByIndex(
                        slideGroupLeaderIndex,
                    );
                }.bind(this),
                251,
            );
        ...
        _handleMediaFocus: function (evt) {
            ...
            var mediaId = evt.currentTarget.getAttribute(
                'data-thumbnail-id',
            );
        ...
        _destroyThumbnailSlider: function () {
            ...
            var sliderTrack = this.container.querySelector(
                '[data-slider-track]',
            );
            var sliderItems = sliderTrack.querySelectorAll(
                '[data-slider-item',
            );
        ...
        _liveRegionText: function (variant) {
            ...
            // Update availability
            var availability = variant.available
                ? ''
        ...
        _updateMedia: function (evt) {
            ...
            var sectionMediaId =
                this.settings.sectionId + '-' + mediaId;
        ...
        _updatePrice: function (evt) {
            ...
            var unitPrice = priceContainer.querySelector(
            ...
            if (!variant) {
                ...
                if (this.productPolicies) {
                    this.productPolicies.classList.add(
                        this.classes.visibilityHidden,
                    );
                }
                return;
            ...
            if (variant.unit_price) {
                ...
                unitPriceBaseUnit.innerHTML = this._getBaseUnit(
                    variant,
                );
                priceContainer.classList.add(
                    this.classes.productUnitAvailable,
        ...
        _getBaseUnit: function (variant) {
            return variant.unit_price_measurement.reference_value ===
                1
        ...
        onUnload: function () {
            ...
            theme.ProductVideo.removeSectionVideos(
                this.settings.sectionId,
            );
            theme.ProductModel.removeSectionModels(
                this.settings.sectionId,
            );

            if (this.mqlSmall) {
                this.mqlSmall.removeListener(
                    this.initMobileBreakpoint,
                );
            }

            if (this.mqlMediumUp) {
                this.mqlMediumUp.removeListener(
                    this.initDesktopBreakpoint,
                );
            }
        },
        ...
        onBlockSelect: function (evt) {
            ...
            if (this.mqlMediumUp.matches) {
                slideIndex = Math.max(
                    ...
                    Math.min(
                        slideIndex,
                        this.slideshow.slides.length - 3,
                    ),
                );
            }
...
theme.SlideshowSection = (function () {
    ...
    function SlideshowSection(container) {
        ...
        this.slideshow = new theme.Slideshow(container, {
            autoplay:
                this.slideshowDom.getAttribute('data-autorotate') ===
                'true',
            slideInterval: this.slideshowDom.getAttribute(
                'data-speed',
            ),
        });
...
theme.SlideshowSection.prototype = Object.assign(
    ...
    theme.SlideshowSection.prototype,
    {
        _setupEventListeners: function () {
            this.eventHandlers.onSliderSlideChanged = function (
                event,
            ) {
        ...
        onBlockSelect: function (evt) {
            ...
            var slideIndex = slide.getAttribute(
                'data-slider-slide-index',
            );
...
document.addEventListener('DOMContentLoaded', function () {
        ...
        inPageLink.addEventListener('click', function (evt) {
            slate.a11y.pageLinkFocus(
                document.getElementById(
                    evt.currentTarget.hash.substr(1),
                ),
            );
        });
    }
    ...
    document.addEventListener('lazyloaded', function (evt) {
        ...
        if (document.body.classList.contains('template-index')) {
            ...
            if (
                ...
                window.performance.mark(
                    'debut:index:first_image_visible',
                );
            }
        }

        if (image.hasAttribute('data-bgset')) {
            var innerImage = image.querySelector(
                selectors.lazyloaded,
            );
    ...
    function onLoadHideLazysizesAnimation() {
        var alreadyLazyloaded = document.querySelectorAll(
            '.lazyloaded',
        );
...
function removeImageLoadingAnimation(image) {
    ...
    var imageWrapper = image.hasAttribute(
        'data-image-loading-animation',
    )
        ? image
